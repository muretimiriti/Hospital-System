...
import { FaHospital, FaUserMd, FaUsers, FaChartBar, FaHistory, FaBars, FaTimes, FaSignOutAlt, FaUserPlus } from 'react-icons/fa';
...
const Navigation: React.FC = () => {
  ...
  const navItems = [
    ...
    { id: 'enrollments', label: 'Enrollments', icon: FaUserPlus, path: '/enrollments' },
